...
export class AppComponent implements OnInit {
  ...
  createTask(taskName){
    return this.toDoService.createTask(taskName.title)
    .subscribe(()=>console.log('success create'));
    
  }
  deleteTask(taskName){
    return this.toDoService.delete(taskName.id)
    .subscribe(()=>{
  ...
  saveTask(task){
    return this.toDoService.changeTaskTitle(task.id, task.title)
    .subscribe(()=>console.log('success change'));
  }
  updateTaskStatus(task){
    return this.toDoService.changeTaskStatus(task.id, task.done)
    .subscribe(()=>console.log('success checked'));
}
 // title = 'app';
